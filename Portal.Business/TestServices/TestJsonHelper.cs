...
namespace Portal.Business.TestServices
{
    public class TestJsonHelper
    {
        ...
        public TestJsonHelper(IArmOneServiceConfigManager configManager)
        {
        ...
        public static IRestResponse MakeRequest(string contentRootPath, string requestUrl, 
                                                string headerHash, bool authenticationRequired = false, 
                                                string username = "", string password = "")
        {
            ...
            {
                Utilities.ManageExceptions.ProcessError(ex, contentRootPath);
                return null;
            }
        }
        ...
        public static string ArmOneTokenPostRequest(string contentRootPath, object data, string requestUrl, 
                                                        string token = null, string sessionString = null)
        {
            try
            {
                var json = JsonConvert.SerializeObject(data);
