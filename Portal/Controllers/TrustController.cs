...
namespace Portal.Controllers
{
    public class TrustController : Controller
    {
        ...
        public TrustController(IProductManager productManager, ICartManager cartManager, IGeneratorsManager generatorsManager)
        {
        ...
        public IActionResult SubmitToCart(ProductsAndProductsItem model)
        {
            ...
            return RedirectToAction($"Details/{model.ProductId}", "Trust");
        }
