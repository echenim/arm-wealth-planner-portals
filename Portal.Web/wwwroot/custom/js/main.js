    ...
    if (typeof Chart !== 'undefined') {
        ...
        if ($("#barChart1").length) {
            ...
            var barData1 = {
                ...
                datasets: [{
                    label: "Sales",
                    backgroundColor: ["#4caf50", "#4caf50", "#4caf50", "#4caf50", "#4caf50", '#4caf50', "#4caf50", "#4caf50", "#4caf50", "#4caf50", "#4caf50", '#4caf50'],
                    borderColor: ['rgba(255,99,132,0)', 'rgba(54, 162, 235, 0)', 'rgba(255, 206, 86, 0)', 'rgba(75, 192, 192, 0)', 'rgba(153, 102, 255, 0)', 'rgba(255, 159, 64, 0)'],
                    borderWidth: 1,
                    data: [24, 42, 18, 34, 56, 28, 65, 70, 65, 44, 89, 68]
                }]
            };
            // -----------------
            // init bar chart
        ...
        if ($("#barChart2").length) {
            ...
            var barData2 = {
                ...
                datasets: [{
                    label: "Sales",
                    backgroundColor: ["#03a9f4", "#03a9f4", "#03a9f4", "#03a9f4", "#03a9f4", '#03a9f4', "#03a9f4", "#03a9f4", "#03a9f4", "#03a9f4", "#03a9f4", '#03a9f4'],
                    borderColor: ['rgba(255,99,132,0)', 'rgba(54, 162, 235, 0)', 'rgba(255, 206, 86, 0)', 'rgba(75, 192, 192, 0)', 'rgba(153, 102, 255, 0)', 'rgba(255, 159, 64, 0)'],
                    borderWidth: 1,
                    data: [24, 42, 18, 34, 56, 28, 65, 70, 65, 44, 89, 68]
                }]
        ...
        if ($("#pieChart1").length) {
            ...
            // pie chart data
            var pieData1 = {
                labels: ["Pensions", "Mutual Funds", "Real Estate", "Securities", "Trustees", "Insurance"],
                datasets: [{
                    data: [50, 350, 100, 30, 70, 20],
                    backgroundColor: ["#5797fc", "#7e6fff", "#4ecc48", "#ffcc29", "#f37070", "#673ab7"],
                    hoverBackgroundColor: ["#5797fc", "#7e6fff", "#4ecc48", "#ffcc29", "#f37070", "#673ab7"],
                    borderWidth: 0
                }]
            };
...
if ($("#liteLineChartIM").length) {
    var liteLineChartIM = $("#liteLineChartIM");

    var liteLineGradientIM = liteLineChartIM[0].getContext('2d').createLinearGradient(0, 0, 0, 100);
    liteLineGradientIM.addColorStop(0, 'rgba(40,97,245,0.1)');
    liteLineGradientIM.addColorStop(1, 'rgba(40,97,245,0)');

    var chartDataIM = [13, 28, 19, 24, 43, 49, 40];

    if (liteLineChartIM.data('chart-data')) chartDataIM = liteLineChartIM.data('chart-data').split(',');
    ...
    // line chart init 
    var myLiteLineChartIM = new Chart(liteLineChartIM, {
        type: 'line',
        data: liteLineDataIM,
        options: {
            legend: {
...
if ($("#liteLineChartIA").length) {
    var liteLineChartIA = $("#liteLineChartIA");

    var liteLineGradientIA = liteLineChartIA[0].getContext('2d').createLinearGradient(0, 0, 0, 100);
    liteLineGradientIA.addColorStop(0, 'rgba(40,97,245,0.1)');
    liteLineGradientIA.addColorStop(1, 'rgba(40,97,245,0)');

    var chartDataIA = [13, 28, 19, 24, 43, 49, 40, 35, 42, 46];

    if (liteLineChartIA.data('chart-data')) chartDataIA = liteLineChartIA.data('chart-data').split(',');
    ...
    // line chart init 
    var myLiteLineChartIA = new Chart(liteLineChartIA, {
        type: 'line',
        data: liteLineDataIA,
        options: {
            legend: {
...
// OUTFLOW THIS MONTH
// init lite line chart OM (outflow month) if element exists

if ($("#liteLineChartOM").length) {
    var liteLineChartOM = $("#liteLineChartOM");

    var liteLineGradientOM = liteLineChartOM[0].getContext('2d').createLinearGradient(0, 0, 0, 100);
    liteLineGradientOM.addColorStop(0, 'rgba(40,97,245,0.1)');
    liteLineGradientOM.addColorStop(1, 'rgba(40,97,245,0)');

    var chartDataOM = [13, 28, 19, 24, 43, 49, 40];

    if (liteLineChartOM.data('chart-data')) chartDataOM = liteLineChartOM.data('chart-data').split(',');
    ...
    // line chart init 
    var myLiteLineChartOM = new Chart(liteLineChartOM, {
        type: 'line',
        data: liteLineDataOM,
        options: {
            legend: {
...
// OUTFLOW ALL TIME
// init lite line chart OA (outflow ALL TIME) if element exists

if ($("#liteLineChartOA").length) {
    var liteLineChartOA = $("#liteLineChartOA");

    var liteLineGradientOA = liteLineChartOA[0].getContext('2d').createLinearGradient(0, 0, 0, 100);
    liteLineGradientOA.addColorStop(0, 'rgba(40,97,245,0.1)');
    liteLineGradientOA.addColorStop(1, 'rgba(40,97,245,0)');

    var chartDataOA = [13, 28, 19, 24, 43, 49, 40, 35, 42, 46];

    if (liteLineChartOA.data('chart-data')) chartDataOA = liteLineChartOA.data('chart-data').split(',');
    ...
    // line chart init 
    var myLiteLineChartOA = new Chart(liteLineChartOA, {
        type: 'line',
        data: liteLineDataOA,
        options: {
            legend: {
...
// init lite line chart FPH if element exists

if ($("#liteLineChartFPH").length) {
    var liteLineChartFPH = $("#liteLineChartFPH");

    var liteLineGradientFPH = liteLineChartFPH[0].getContext('2d').createLinearGradient(0, 0, 0, 100);
    liteLineGradientFPH.addColorStop(0, 'rgba(40,97,245,0.5)');
    liteLineGradientFPH.addColorStop(1, 'rgba(40,97,245,0)');

    var chartDataFPH = [413, 428, 419, 424, 443, 449, 440, 435, 442, 446, 448, 450];


    if (liteLineChartFPH.data('chart-data')) chartDataFPH = liteLineChartFPH.data('chart-data').split(',');
    ...
    // line chart init 
    var myLiteLineChartFPH = new Chart(liteLineChartFPH, {
        type: 'line',
        data: liteLineDataFPH,
        options: {
            legend: {
                display: true
            },
